...
# Single-arch libraries for compiler intrinsics, to be phased out
NATIVE_LIBS += $(wildcard native/*.a)
...
$$(BUILDDIR)/$(1)/$(1).elf: $$(OBJS_$(1)) $$(NATIVE_LIBS) $$(LIBS_$(1)) $(LAYOUT) | $$(BUILDDIR)/$(1)
	$$(TRACE_LD)
	$$(Q)$$(CC) $$(CFLAGS) -mcpu=$(1) $$(CPPFLAGS) $$(CPPFLAGS_$(1))\
	    ...
	    -T $(LAYOUT)\
	    -nostdlib\
	    -Wl,--start-group $$(OBJS_$(1)) $$(LIBS_$(1)) $$(NATIVE_LIBS) -Wl,--end-group\
...
$$(BUILDDIR)/$(1)/$(1).userland_debug.ld: $(LAYOUT) $$(BUILDDIR)/$(1)/$(1).elf _FORCE_USERLAND_DEBUG_LD
...
$$(BUILDDIR)/$(1)/$(1).userland_debug.elf: $$(OBJS_$(1)) $$(NATIVE_LIBS) $$(LIBS_$(1)) $$(BUILDDIR)/$(1)/$(1).userland_debug.ld | $$(BUILDDIR)/$(1)
	$$(TRACE_LD)
...
fmt format::
	$(Q)$(BASE_DIR)/tools/check_override.sh
