...
- [Tock Course](./course/course.md)
  ...
  - [Soil Moisture Sensor](./course/soil-moisture/overview.md)
    - [Kernel: Sensor Setup](./course/soil-moisture/kernel-sensor.md)
    - [Application 1: Sensor](./course/soil-moisture/app-sensor.md)
    - [Kernel: Display Setup](./course/soil-moisture/kernel-display.md)
