...
#
# These lines are changed from the libtock-c version.
####

LIBS_cortex-m0 += $(TOCK_USERLAND_BASE_DIR)/libtock/build/cortex-m0/libtock.a
LIBS_cortex-m3 += $(TOCK_USERLAND_BASE_DIR)/libtock/build/cortex-m3/libtock.a
LIBS_cortex-m4 += $(TOCK_USERLAND_BASE_DIR)/libtock/build/cortex-m4/libtock.a
